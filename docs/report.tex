...
if (callContract && included) //External call
	...
	\pagebreak
	\section{Test cases with transaction hashes Multi-contract}
	\label{app:test-cases-with-transaction-hashes-multi-contract}
	...
	\pagebreak
	\section{Test cases with transaction hashes Mono-contract}
	\label{app:test-cases-with-transaction-hashes-mono-contract}
