...
\pagenumbering{Alph}
	...
	We will therefore be experimenting with several different system structures and comparing their costs in order to find the best solution.
		...
		Interested parties can review the previously mentioned thesis in which there is references to a great deal of literature to support this claim.
			...
			The consensus algorithms in Bitcoin and Ethereum are nearly identical, i.e. block mining, and thus it should be relatively trivial to show that the same arguments presented for Bitcoin's consensus algorithm in \cite{anonymous-byzantine-consensus} holds for Ethereum.
			...
			For further study, we suggest starting there.
