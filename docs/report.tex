...
for(i = 0; i < relations.length; i=i+2){
	...
	\section{Optimizations}
		...
		\begin{snippet}[ht!]
			\centering
			\lstinputlisting[language=solidity, firstline=11, lastline=30, numbers=none]{../contracts/optimizations/monolith-bitfields.sol}
	...
	\section{Mono-contract code with bitfields}
		...
		\lstinputlisting[language=solidity]{../contracts/optimizations/monolith-bitfields.sol}
