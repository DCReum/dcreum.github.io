...
for(i = 0; i < relations.length; i=i+2){
	...
	\section{Further features}
		...
		An alternative to this, could be to create external relations between the workflows, as described in \cite{distributed-workflows}, as long as that the user creating the relations has some sort of ownership of both workflows.
