...
for(i = 0; i < relations.length; i=i+2){
	...
	\section{Further features}
		...
		External relations can both be inter-workflow relations roughly as described in \cite{distributed-workflows} or relations from activities in contracts which automatically execute activities based on certain criteria. 
		Examples of the second type of external relations could be:
		\begin{enumerate}
